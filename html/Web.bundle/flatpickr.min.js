            ...
            if (D.isMobile)
              return void (function () {
                ...
                ((D.mobileInput = s('input', D.input.className + ' flatpickr-mobile')),
                  ...
                  (D.mobileFormatStr =
                    'datetime-local' === e ? 'M-d-y\\TH:i:S' : 'date' === e ? 'M-d-y' : 'H:i:S'),
                  D.selectedDates.length > 0 &&
                    (D.mobileInput.defaultValue = D.mobileInput.value =
                      D.formatDate(D.selectedDates[0], D.mobileFormatStr)));
                D.config.minDate && (D.mobileInput.min = D.formatDate(D.config.minDate, 'M-d-y'));
                D.config.maxDate && (D.mobileInput.max = D.formatDate(D.config.maxDate, 'M-d-y'));
