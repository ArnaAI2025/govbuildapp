...
const Content = ({
  ...
  const sevenDays = language ? getTranslation(language).weekDays : getTranslation('en').weekDays;
      ...
      <View style={[styles.header, { backgroundColor: headerColor }]}>
        ...
        <TouchableOpacity style={styles.changeMonthTO} onPress={onPrev} disabled={btnDisabled}>
          <Image
            ...
            source={require('../../../../assets/images/left_arrow_new.png')}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.changeMonthTO} onPress={onNext} disabled={btnDisabled}>
          <Image
            style={styles.iconStyle}
            source={require('../../../../assets/images/right_arrow_new.png')}
          />
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.keys_container}>
        ...
        {sevenDays.map((weekDay: string, index: number) => (
          <View style={styles.keys} key={index.toString()}>
            <Text style={[styles.weekDays, { color: weekDaysColor }]}>{weekDay}</Text>
          </View>
        ))}
